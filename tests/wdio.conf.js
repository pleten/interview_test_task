...
const { setupConfig } = require('./config/test-config');
...
if(process.env.HEADLESS == true || process.env.HEADLESS === 'true') {
    ...
    maxInstances = +process.env.INSTANCES || 10;
    waitforTimeout = +process.env.WAIT_TIMEOUT || 120000;
}
...
exports.config = {
    ...
    baseUrl: process.env.BASEURL ? process.env.BASEURL : 'https://ssls.com',
    //
    ...
    before: function (capabilities, specs) {
        browser.setTimeout({ 'implicit': 7000 });
        setupConfig();
